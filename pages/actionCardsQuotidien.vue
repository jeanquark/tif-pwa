			...
			<v-card class="card">
				...
				<v-card-text class="card-text mx-2" style="padding: 0">
					<v-container fluid style="padding: 1px">
						<v-layout row wrap style="margin: 1px; background-color: white; border: 2px solid SaddleBrown; border-radius: 5px">
							<v-flex xs12 sm6 md6 style="padding: 5px">
								<v-card style="background-color: white; border: 2px solid SaddleBrown; border-radius: 5px; position: relative; min-height: 73%">
									<v-card-actions style="padding: 5px; text-align: center">
										...
										<span class="gommetteDollar blackOpacity">
				...
				<v-card-actions class="card-footer">
					<v-flex class="text-xs-center">
						<v-btn nuxt color="orangered" to="/actionCardsQuotidienActivee" class="elevation-1" style="margin-bottom: 20px; background-color: orangered">Utiliser cette action !</v-btn>
					</v-flex>
				</v-card-actions>
			</v-card>
		</v-flex>
...
.card {
background: linear-gradient(135deg, rgba(206,102,28,1) 0%, rgba(139,69,19,1) 50%, rgba(117,58,16,1) 51%, rgba(72,36,10,1) 100%);
border-radius: 5px;
margin: 5px;
}
.card-text {
