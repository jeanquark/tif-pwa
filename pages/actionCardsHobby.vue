		...
		<v-flex xs12 sm10 md8 lg6>
			<v-card class="card">
				<v-card-title primary-title>
					<v-flex xs9>
						<span class="titleModalCards text-xs-left">Créateur de château de sable</span>
					</v-flex>
				...
				<v-card-actions class="card-footer">
					<v-flex class="text-xs-center">
						<v-btn nuxt color="orangered" to="/actionCardsHobbyActivee" class="elevation-1" style="margin-bottom: 20px; background-color: orangered">Utiliser cette action !</v-btn>
					</v-flex>
				</v-card-actions>
			</v-card>
		</v-flex>
...
.card {
background: linear-gradient(135deg, rgba(0,0,216,1) 0%, rgba(0,0,165,1) 50%, rgba(0,0,114,1) 51%, rgba(0,0,63,1) 100%);
border-radius: 5px;
margin: 5px;
}
.card-text {
