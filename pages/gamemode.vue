        ...
        <v-container fluid id="header" class="header" style="height: 162px">
            <v-layout row>
                <v-flex class="barreHeader">
                    <v-layout row>
                        <v-flex xs6 sm6 md6>
                            <span style="margin-left: 100px; float: left; margin-top: 4px"><img src="/images/switzerland.png" class="imgTeamSmall" /></span> <span style="color: white; padding: 4px; float: left; margin-top: 9px">G. Manigley (41 ans)</span>
                        </v-flex>
                        <v-flex xs6 sm6 md6>
		...
		<v-container fluid style="padding: 0; max-width: 1000px; background-color: whitesmoke">
            <div class="centreImage" style="position: relative">
                ...
                <div class="content">
					...
					<img src="/images/carte.jpg" usemap="#image-map" class="linear-gradient">
					<map name="image-map">
						<area target="_blank" alt="france" title="france" href="123456.html" coords="811,385,851,368,875,383,877,423,830,427" shape="poly">
					</map>
                </div>
            </div>
        </v-container>
