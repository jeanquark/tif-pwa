        ...
        <v-container fluid style="padding: 0; max-width: 1000px; background-color: whitesmoke">
            <div class="centreImage">
                <div class="content">
					...
					<map name="image-map">
						<area target="_blank" alt="france" title="france" href="123456.html" coords="811,385,851,368,875,383,877,423,830,427" shape="poly" style="border: 2px solid orangered">
					</map>
                </div>
                <div style="position: fixed; margin-top: 50px; text-align: center">
