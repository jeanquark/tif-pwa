			...
			<v-card class="card">
				...
				<v-card-text class="card-text mx-2" style="padding: 0">
					<v-container fluid style="padding: 1px">
						<v-layout row wrap style="margin: 1px; background-color: white; border: 2px solid darkviolet; border-radius: 5px">
...
.card {
background: linear-gradient(135deg, rgba(189,33,255,1) 0%, rgba(148,0,211,1) 50%, rgba(130,0,186,1) 51%, rgba(94,0,135,1) 100%);
border-radius: 5px;
margin: 5px;
}
.card-text {
