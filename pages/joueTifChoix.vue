            ...
            <div class="content" style="position: relative">
				...
				<div class="cadreScore hidden-xs-only" style="position: absolute">
					<v-flex xs12 style="margin: 0; height: 100%">
						<v-layout align-start>
							<div class="nameTeam">
								Au match <span class="nameOtherTeam">Choisis où tu vas voir le match !</span>
							</div>
				...
				<v-layout row wrap class="layoutTheme puff-in-center">
					<v-flex xs6 sm4 md4 style="padding: 5px">
						<nuxt-link to="/joueTifStadeVip" style="text-decoration: none">
							<v-card style="background-color: white; border: 2px solid orangered; border-radius: 5px; position: relative; min-height: 73%">
								...
								<v-layout>
									<v-flex xs12 style="text-align: center; padding: 0">
										<img src="/images/soccer.png" class="imgInventory"/>
									</v-flex>
								</v-layout>
								<v-card-actions style="padding: 5px; text-align: center">
					...
					<v-flex xs6 sm4 md4 style="padding: 5px">
						<nuxt-link to="/joueTifStadeTribune" style="text-decoration: none">
							<v-card style="background-color: white; border: 2px solid orangered; border-radius: 5px; position: relative; min-height: 73%">
								<v-card-actions style="padding: 5px; text-align: center">
									<span class="gommetteEnergy yellow">
										<i class="material-icons gommetteIcone">flash_on</i>
					...
					<v-flex xs6 sm4 md4 style="padding: 5px">
						<nuxt-link to="/joueTifStadeKop" style="text-decoration: none">
							<v-card style="background-color: white; border: 2px solid orangered; border-radius: 5px; position: relative; min-height: 73%">
								<v-card-actions style="padding: 5px; text-align: center">
									<span class="gommetteEnergy yellow">
										<i class="material-icons gommetteIcone">flash_on</i>
					...
					<v-flex xs6 sm4 md4 style="padding: 5px">
						<nuxt-link to="/joueTifEcranGeant" style="text-decoration: none">
							<v-card style="background-color: white; border: 2px solid orangered; border-radius: 5px; position: relative; min-height: 73%">
								<v-card-actions style="padding: 5px; text-align: center">
									<span class="gommetteEnergy yellow">
										<i class="material-icons gommetteIcone">flash_on</i>
