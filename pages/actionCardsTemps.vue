			...
			<v-card class="card">
				...
				<v-card-text class="card-text mx-2" style="padding: 0">
					<v-container fluid style="padding: 1px">
						<v-layout row wrap style="margin: 1px; background-color: white; border: 2px solid teal; border-radius: 5px">
				...
				<v-card-actions class="card-footer">
					<v-flex class="text-xs-center">
						<v-btn nuxt color="orangered" to="/actionCardsTempsActivee" class="elevation-1" style="margin-bottom: 20px; background-color: orangered">Utiliser cette action !</v-btn>
					</v-flex>
				</v-card-actions>
			</v-card>
		</v-flex>
...
.card {
background: linear-gradient(135deg, rgba(0,205,205,1) 0%, rgba(0,128,128,1) 50%, rgba(37,63,63,1) 51%, rgba(0,52,52,1) 100%);
border-radius: 5px;
margin: 5px;
}
.card-text {
