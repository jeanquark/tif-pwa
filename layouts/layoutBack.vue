		...
		data () {
			return {
				...
				items: [
					...
					{ icon: 'list-ol', text: 'Competitions', to: '/admin/competitions', exact: false },
					{ icon: 'flag', text: 'Teams', to: '/admin/teams', exact: false },
					{ icon: 'user-plus', text: 'Players', to: '/admin/players', exact: false },
					{ icon: 'building', text: 'Stadiums', to: '/admin/stadiums', exact: false },
					{ icon: 'calendar', text: 'Events', to: '/admin/events', exact: false },
					{ icon: 'language', text: 'Translation', to: '/admin/translations', exact: false },
					{ icon: 'database', text: 'API', to: '/admin/api', exact: false },
				]
			}
		},
		computed: {
